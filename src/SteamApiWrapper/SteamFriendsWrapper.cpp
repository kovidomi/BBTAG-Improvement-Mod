...
bool SteamFriendsWrapper::IsClanPublic(CSteamID steamIDClan)
{
	LOG(7, "IsClanPublic\n");
	return m_SteamFriends->IsClanPublic(steamIDClan);
}

bool SteamFriendsWrapper::IsClanOfficialGameGroup(CSteamID steamIDClan)
{
	LOG(7, "IsClanOfficialGameGroup\n");
	return m_SteamFriends->IsClanOfficialGameGroup(steamIDClan);
}